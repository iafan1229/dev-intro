...
const GlitterBackground = dynamic(() => import("@/components/Scene3D"), { ssr: false });
  ...
  return (
    <div className="min-h-screen bg-white relative">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
            ...
            <div className="flex-1 text-center md:text-left">
              <h1 className="text-6xl md:text-8xl font-extrabold mb-8 leading-tight tracking-tighter">
                ...
                <span className="block text-gray-500 mt-2">프론트엔드 개발자</span>
      ...
      <section id="skills" className="border-t border-gray-200">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="mb-16 text-center md:text-left" style={{ paddingBottom: '40px' }}>
            <span className="text-gray-400 font-bold text-lg mb-2 block">01. Skills</span>
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold mb-4 text-gray-900 text-center md:text-left">프론트엔드</h3>
              <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                <span className="px-4 py-2 text-gray-900 rounded-lg text-lg">Next.js</span>
                <span className="px-4 py-2 text-gray-900 rounded-lg text-lg">React</span>
                <span className="px-4 py-2 text-gray-900 rounded-lg text-lg">TypeScript</span>
                <span className="px-4 py-2 text-gray-900 rounded-lg text-lg">JavaScript</span>
              </div>
            </div>
            <div style={{paddingTop:'20px'}}>
              <h3 className="text-2xl font-bold mb-4 text-gray-900 text-center md:text-left">모바일</h3>
              <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                <span className="px-4 py-2 text-gray-900 rounded-lg text-lg">React Native</span>
                <span className="px-4 py-2 text-gray-900 rounded-lg text-lg">Expo</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="projects" className="border-t border-gray-200">
        <div className="container mx-auto px-6">
          <div className="mb-16 text-center md:text-left" style={{ paddingBottom: '40px' }}>
            <span className="text-gray-400 font-bold text-lg mb-2 block">02. Projects</span>
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tighter text-gray-900 inline-block relative">
              프로젝트
              <span className="absolute -bottom-2 left-0 w-full h-1 bg-gray-900 origin-left transform scale-x-100 transition-transform duration-300"></span>
            </h2>
              ...
              <div className="flex flex-col gap-6 mb-6">                 
                <div className="flex flex-col lg:flex-row flex-wrap items-center lg:items-start gap-8 lg:gap-12">
                  ...
                  <div className="text-center md:text-left">
                    ...
                    <p className="text-lg text-gray-600 mb-4 leading-relaxed" style={{paddingTop:10}}>
                      운동 기록을 쉽고 간편하게 관리할 수 있는 피트니스 앱입니다.<br/>
                      직관적인 UI/UX로 누구나 쉽게 사용할 수 있으며, <br/>운동 루틴을 체계적으로 관리할 수 있습니다.
                    </p>
                    <div className="flex flex-wrap gap-2 mb-6 justify-center md:justify-start" style={{paddingTop:20}}>
                      <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded text-sm">React Native</span>
                      <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded text-sm">Expo</span>
                      <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded text-sm">TypeScript</span>
                    </div>
                    <div className="flex justify-center md:justify-start" style={{paddingTop:20}}>
                      <AppStoreButton />
                    </div>
                  </div>
      ...
      <section id="experience" className="border-t border-gray-200">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="mb-16 text-center md:text-left" style={{ paddingBottom: '40px' }}>
            <span className="text-gray-400 font-bold text-lg mb-2 block">03. Experience</span>
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tighter text-gray-900 inline-block relative">
              경력
              <span className="absolute -bottom-2 left-0 w-full h-1 bg-gray-900 origin-left transform scale-x-100 transition-transform duration-300"></span>
            </h2>
      ...
      {/* Footer */}
      <footer className="border-t border-gray-200 py-12 mt-24" style={{paddingTop:24, textAlign:'center'}}>
        <div className="container mx-auto px-6 max-w-4xl">
